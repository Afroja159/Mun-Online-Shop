...
class WhiteningScreen extends StatefulWidget {
  const WhiteningScreen({super.key});

  @override
  State<WhiteningScreen> createState() => _WhiteningScreenState();
}

class _WhiteningScreenState extends State<WhiteningScreen> {
  @override
